...
struct na_class_ops {
    ...
    na_return_t (*addr_deserialize)(na_class_t *na_class, na_addr_t **addr_p,
        const void *buf, size_t buf_size);
    na_return_t (*addr_set_firewall)(na_class_t *na_class, na_addr_t *addr);
...
/*---------------------------------------------------------------------------*/
static NA_INLINE na_return_t
NA_Addr_set_firewall(na_class_t *na_class, na_addr_t *addr)
{
    return na_class->ops->addr_set_firewall(na_class, addr);
}
